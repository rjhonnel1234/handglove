...
(new WOW).init();var HOME={init:function(){setTimeout(function(){$(".wrapper").addClass("loaded")},500),HOME.build.carousel(),HOME.events.init()},build:{carousel:function(){$(".three-item-carousel").length&&$(".three-item-carousel").owlCarousel({loop:!0,margin:30,nav:!0,smartSpeed:1e3,autoplay:500,navText:['<span class="flaticon-left-arrow-1"></span>','<span class="flaticon-right-arrow"></span>'],responsive:{0:{items:1},480:{items:1},600:{items:2},800:{items:2},1024:{items:3}}}),$(".latest-project-carousel").length&&$(".latest-project-carousel").owlCarousel({loop:!0,margin:30,nav:!0,smartSpeed:1e3,autoplay:500,navText:['<span class="flaticon-left-arrow-1"></span>','<span class="flaticon-right-arrow"></span>'],responsive:{0:{items:1},480:{items:1},600:{items:1},800:{items:2},1024:{items:2}}}),$(".tabs-box").length&&$(".tabs-box .tab-buttons .tab-btn").on("click",function(t){t.preventDefault();t=$($(this).attr("data-tab"));if($(t).is(":visible"))return!1;t.parents(".tabs-box").find(".tab-buttons").find(".tab-btn").removeClass("active-btn"),$(this).addClass("active-btn"),t.parents(".tabs-box").find(".tabs-content").find(".tab").fadeOut(0),t.parents(".tabs-box").find(".tabs-content").find(".tab").removeClass("active-tab"),$(t).fadeIn(300),$(t).addClass("active-tab")}),$(".count-bar").length&&$(".count-bar").appear(function(){var t=$(this),a=t.data("percent");$(t).css("width",a).addClass("counted")},{accY:-50}),$(".banner-carousel").length&&$(".banner-carousel").owlCarousel({loop:!0,margin:0,nav:!0,animateOut:"fadeOut",animateIn:"fadeIn",active:!0,smartSpeed:1e3,autoplay:!0,navText:['<span class="flaticon-arrowhead-thin-outline-to-the-left"></span>','<span class="flaticon-right-arrow-2"></span>'],responsive:{0:{items:1},600:{items:1},800:{items:1},1024:{items:1}}}),$(".clients-carousel").length&&$(".clients-carousel").owlCarousel({loop:!0,margin:0,nav:!1,smartSpeed:3e3,autoplay:!0,navText:['<span class="flaticon-arrowhead-thin-outline-to-the-left"></span>','<span class="flaticon-right-arrow-2"></span>'],responsive:{0:{items:1},480:{items:2},600:{items:3},800:{items:4},1200:{items:6}}}),$(".three-item-carousel").length&&$(".three-item-carousel").owlCarousel({loop:!0,margin:30,nav:!0,smartSpeed:1e3,autoplay:500,navText:['<span class="flaticon-left-arrow-1"></span>','<span class="flaticon-right-arrow"></span>'],responsive:{0:{items:1},480:{items:1},600:{items:2},800:{items:2},1024:{items:3}}}),$(".testimonial-carousel").length&&$(".testimonial-carousel").owlCarousel({loop:!0,margin:30,nav:!0,smartSpeed:3e3,autoplay:4e3,navText:['<span class="flaticon-left-2"></span>','<span class="flaticon-right-1"></span>'],responsive:{0:{items:1},480:{items:1},600:{items:1},800:{items:2},1024:{items:2}}}),$(".location-carousel").length&&$(".location-carousel").owlCarousel({loop:!0,margin:0,nav:!0,animateOut:"fadeOut",animateIn:"fadeIn",active:!0,smartSpeed:1e3,autoplay:6e3,navText:['<i class="fa fa-chevron-left"></i>','<i class="fa fa-chevron-right"></i>'],responsive:{0:{items:1},600:{items:1},800:{items:1},1024:{items:1}}}),$(".accordion-box").length&&$(".accordion-box").on("click",".acc-btn",function(){var t=$(this).parents(".accordion-box"),a=$(this).parents(".accordion");if(!0!==$(this).hasClass("active")&&$(t).find(".accordion .acc-btn").removeClass("active"),$(this).next(".acc-content").is(":visible"))return!1;$(this).addClass("active"),$(t).children(".accordion").removeClass("active-block"),$(t).find(".accordion").children(".acc-content").slideUp(300),a.addClass("active-block"),$(this).next(".acc-content").slideDown(300)})}},events:{init:function(){HOME.events.onHoverthreeDmovement()},onHoverthreeDmovement:function(){$(".js-tilt").length&&$(".js-tilt").tilt({maxTilt:20,perspective:700,glare:!0,maxGlare:0})}}};$(document).ready(HOME.init);