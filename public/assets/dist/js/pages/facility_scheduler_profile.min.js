...
Dropzone.autoDiscover=!1;var FACILITY_SCHEDULER_PROFILE={dropzone:null,calendar:null,init:function(){FACILITY_SCHEDULER_PROFILE.build.calendar(),FACILITY_SCHEDULER_PROFILE.build.dropzone(),FACILITY_SCHEDULER_PROFILE.events()},events:function(){$("#uploadScheduleModal").on("hidden.bs.modal",function(){FACILITY_SCHEDULER_PROFILE.dropzone&&FACILITY_SCHEDULER_PROFILE.dropzone.removeAllFiles(),$("#uploadScheduleForm")[0].reset()}),$("#btnUploadSchedule").on("click",function(e){e.preventDefault(),0<FACILITY_SCHEDULER_PROFILE.dropzone.getQueuedFiles().length?FACILITY_SCHEDULER_PROFILE.build.upload():toastr.error("Please select a file to upload.")})},build:{calendar:function(){var a,e=document.getElementById("scheduler-calendar");e&&(a=(new Date).toISOString().split("T")[0],FACILITY_SCHEDULER_PROFILE.calendar=new FullCalendar.Calendar(e,{initialView:"dayGridMonth",headerToolbar:{left:"prev,next today",center:"title",right:"dayGridMonth"},themeSystem:"bootstrap",height:"auto",selectable:!0,fixedWeekCount:!1,dayMaxEvents:!0,events:{url:GLOBAL_BASE_URL+"facility/schedules/list",method:"POST",extraParams:function(){var e={};return"undefined"!=typeof GLOBAL_CSRF_TOKEN&&(e[GLOBAL_CSRF_TOKEN]=GLOBAL_CSRF_HASH),e}},eventContent:function(e){return console.info(e),{html:e.event.extendedProps.html}},eventDidMount:function(){$('[data-toggle="tooltip"]').tooltip()},dateClick:function(t){var e,o;new Date(t.dateStr)<new Date(a)||FACILITY_SCHEDULER_PROFILE.calendar.getEvents().some(function(e){return e.startStr===t.dateStr})||($("#selected-date").val(t.dateStr),e=t.dateStr,o=t.dateStr,$("#selected-date-display").text(o),o=GLOBAL_BASE_URL+"facility/schedules/add?date="+e,$(".upload-new-schedule, .btn.thm-btn.mr-auto").attr("href",o),$("#uploadScheduleModal").modal("show"))}}),FACILITY_SCHEDULER_PROFILE.calendar.render())},dropzone:function(){0<$("#schedule-dropzone").length&&(Dropzone.autoDiscover=!1,FACILITY_SCHEDULER_PROFILE.dropzone=new Dropzone("#schedule-dropzone",{url:GLOBAL_BASE_URL+"facility/schedules/upload",paramName:"file",maxFiles:1,acceptedFiles:".pdf",autoProcessQueue:!1,headers:{"X-Requested-With":"XMLHttpRequest"},init:function(){this.on("addedfile",function(){null!=this.files[1]&&this.removeFile(this.files[0])})}}))},upload:function(){var e,t=FACILITY_SCHEDULER_PROFILE.dropzone.getQueuedFiles();0===t.length?toastr.error("Please select a file to upload."):((e=new FormData).append("file",t[0]),e.append("shift_date",$("#selected-date").val()),"undefined"!=typeof GLOBAL_CSRF_TOKEN&&e.append(GLOBAL_CSRF_TOKEN,GLOBAL_CSRF_HASH),$("#btnUploadSchedule").prop("disabled",!0).text("Uploading..."),$.ajax({url:GLOBAL_BASE_URL+"facility/schedules/upload",type:"POST",data:e,processData:!1,contentType:!1,dataType:"json",success:function(e){1==e.success?(toastr.success(e.message),$("#uploadScheduleModal").modal("hide"),FACILITY_SCHEDULER_PROFILE.dropzone.removeAllFiles(),FACILITY_SCHEDULER_PROFILE.calendar&&FACILITY_SCHEDULER_PROFILE.calendar.refetchEvents(),console.info(e)):toastr.error(e.message)},error:function(){toastr.error("An error occurred during upload.")},complete:function(){$("#btnUploadSchedule").prop("disabled",!1).text("Upload")}}))}}};$(document).ready(FACILITY_SCHEDULER_PROFILE.init);