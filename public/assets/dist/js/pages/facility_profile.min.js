...
(new WOW).init();var PROFILE={currentPage:1,limit:3,init:function(){PROFILE.events.init(),PROFILE.build.loadReviews(),PROFILE.build.invoicesDataTable()},events:{init:function(){PROFILE.events.vote(),PROFILE.events.loadMore(),PROFILE.events.invoiceFilter(),PROFILE.build.payButton()},invoiceFilter:function(){$("#invoiceStatus").change(function(){$("#invoices-table").DataTable().ajax.reload()})},vote:function(){$(".vote-clinician").click(function(){var e=$(this).data("voting_id"),a=$(this).data("clinician_id");$.ajax({url:GLOBAL_BASE_URL+"facility/vote",data:{votingID:e,clinicianID:a},type:"POST",dataType:"json",success:function(e){1==e.success?(toastr.success(e.message,e.message_header),setTimeout(function(){location.reload()},2e3)):toastr.error(e.message,e.message_header)}})})},loadMore:function(){$(document).on("click",".review-page-link",function(e){e.preventDefault();e=$(this).data("page");PROFILE.currentPage=e,PROFILE.build.loadReviews(),$("html, body").animate({scrollTop:$("#reviewsSection").offset().top-100},500)})}},build:{loadReviews:function(){var e=$("#reviewsContainer").data("client_id");0==$("#reviewsContainer").data("total")?$("#noReviewsMsg").show():($("#reviewsContainer").css("opacity","0.5"),$.ajax({url:GLOBAL_BASE_URL+"facility/get_reviews",data:{client_id:e,page:PROFILE.currentPage},type:"POST",dataType:"json",success:function(e){1==e.success&&($("#reviewsContainer").html(e.html).css("opacity","1"),PROFILE.build.renderPagination(e.total_pages,e.current_page))}}))},renderPagination:function(e,a){if(e<=1)$("#paginationContainer").empty();else{for(var t='<nav aria-label="Page navigation"><ul class="pagination pagination-sm mb-0">',t=(t+='<li class="page-item '+(1==a?"disabled":"")+'">')+('<a class="page-link review-page-link" href="#" data-page="'+(parseInt(a)-1)+'">Previous</a></li>'),i=1;i<=e;i++)t=t+'<li class="page-item '+(i==a?"active":"")+'"><a class="page-link review-page-link" href="#" data-page="'+i+'">'+i+"</a></li>";t=(t+='<li class="page-item '+(a==e?"disabled":"")+'">')+('<a class="page-link review-page-link" href="#" data-page="'+(parseInt(a)+1)+'">Next</a></li>')+"</ul></nav>",$("#paginationContainer").html(t)}},invoicesDataTable:function(){0<$("#invoices-table").length&&($("#invoices-table").DataTable({paging:!0,lengthChange:!1,pageLength:10,searching:!1,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/invoices/list",dataSrc:"data",type:"POST",data:function(e){e.status=$("#invoiceStatus").val()}},columns:[{data:"checkbox",className:"text-center align-middle pl-4"},{data:"clinician",className:"align-middle"},{data:"hours",className:"text-center align-middle"},{data:"rate",className:"text-right align-middle font-weight-bold"},{data:"total",className:"text-right align-middle font-weight-bold"},{data:"status",className:"text-center align-middle"},{data:"action",className:"text-center align-middle"}],drawCallback:function(){$("#checkAllInvoices").prop("checked",!1),$("#paySelectedBtn").hide()}}),$("#checkAllInvoices").on("change",function(){$(".invoice-checkbox:not(:disabled)").prop("checked",$(this).prop("checked")),PROFILE.build.togglePayBtn()}),$("#invoices-table").on("change",".invoice-checkbox",function(){PROFILE.build.togglePayBtn()}),$("#paySelectedBtn").on("click",function(){var e=[];$(".invoice-checkbox:checked").each(function(){e.push($(this).val())}),0<e.length&&(window.location.href=GLOBAL_BASE_URL+"facility/manage/invoices/view/"+e.join(":"))}))},togglePayBtn:function(){0<$(".invoice-checkbox:checked").length?$("#paySelectedBtn").show():$("#paySelectedBtn").hide()},payButton:function(){$("#btnPayBatch").click(function(){var a=$(this).data("ids").toString().split(":");Swal.fire({title:"Stripe Payment",text:"You will be redirected to Stripe to securely complete your payment.",icon:"info",showCancelButton:!0,confirmButtonColor:"#007bff",cancelButtonColor:"#d33",confirmButtonText:"Proceed to Checkout"}).then(e=>{e.isConfirmed&&$.ajax({url:GLOBAL_BASE_URL+"facility/manage/invoices/checkout",data:{invoiceIds:a},type:"POST",dataType:"json",success:function(e){1==e.success?window.location.href=e.url:toastr.error(e.message,"Checkout Error")},error:function(){toastr.error("An unexpected error occurred. Please try again.","Error")}})})})}}};$(document).ready(PROFILE.init);