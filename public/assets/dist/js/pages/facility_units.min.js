...
(new WOW).init();var FACILITY_UNITS={init:function(){FACILITY_UNITS.build.table(),FACILITY_UNITS.events.init()},events:{init:function(){FACILITY_UNITS.events.viewUnit(),FACILITY_UNITS.events.addUnit()},addUnit:function(){$("#submitUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/units/add",data:$("#unitAddForm").serialize(),type:"POST",dataType:"json",success:function(a){1==a.success?(toastr.success(a.message,a.message_header),$("#units_table").DataTable().ajax.reload(),$("#unitAddForm")[0].reset(),$("#addUnitModal").modal("hide")):toastr.error(a.message,a.message_header)}})})},removeUnit:function(){$("#units_table").on("click",".remove-unit",function(){})},viewUnit:function(){$("#units_table").on("click",".view-unit",function(){var a=$(this).data("id");$.ajax({url:GLOBAL_BASE_URL+"facility/manage/units/get",data:{unitID:a},type:"POST",dataType:"json",success:function(a){1==a.success&&($("#unitID").val(a.unit.id),$("#unitName").val(a.unit.name),$("#edit_unit_manager_id").val(a.unit.unit_manager_id).selectpicker("refresh"),$("#unitCensus_1").val(a.unit.census_1),$("#unitCensus_2").val(a.unit.census_2),$("#unitDescription").val(a.unit.description),$("#unitModal").modal("show"))}})}),$("#updateUnit").click(function(){$.ajax({url:GLOBAL_BASE_URL+"facility/manage/units/update",data:$("#unitUpdateForm").serialize(),type:"POST",dataType:"json",success:function(a){1==a.success?(toastr.success(a.message,a.message_header),$("#units_table").DataTable().ajax.reload(),$("#unitUpdateForm")[0].reset(),$("#unitModal").modal("hide")):toastr.error(a.message,a.message_header)}})})}},build:{table:function(){$("#units_table").DataTable({paging:!0,lengthChange:!1,pageLength:10,ordering:!1,ajax:{url:GLOBAL_BASE_URL+"facility/manage/units/list",dataSrc:"data",type:"POST"},columns:[{data:"name"},{data:"census"},{data:"description"},{data:"action"}]})}}};$(document).ready(FACILITY_UNITS.init);