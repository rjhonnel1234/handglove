...
/* p { line-height: 1.33em; color: #7E7E7E; } #loader-wrapper { position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 1000; } #loader { display: block; position: relative; left: 50%; top: 50%; width: 150px; height: 150px; margin: -75px 0 0 -75px; border-radius: 50%; z-index: 1001; animation: spin 2s linear infinite; &:before { content: ""; position: absolute; top: 5px; left: 5px; right: 5px; bottom: 5px; border-radius: 50%; animation: spin 3s linear infinite; } &:after { content: ""; position: absolute; top: 15px; right: 15px; left: 15px; bottom: 15px; border-radius: 50%; } } #loader-wrapper .loader-section { position: fixed; top: 0; width: 51%; height: 100%; background-color: lightgray; background-size: cover; background-repeat: no-repeat; background-position: center; background-blend-mode: multiply; z-index: 1000; transform: translateX(0); } #loader-wrapper .loader-section.section-left { left: 0; } #loader-wrapper .loader-section.section-right { right: 0; } #loader { display: block; width: 100px; height: 100px; margin: 50 auto; } .circ-one { position: relative; display: block; width: 50px; height: 50px; background: rgba(217,91,67,1); border-radius: 100%; float: left; animation: load-x 1s cubic-bezier(0.445, 0.100, 0.550, 0.900) infinite; } .circ-two { position: relative; display: block; width: 50px; height: 50px; background: rgba(84,36,55,1); border-radius: 100%; float: right; animation: load-y 1s cubic-bezier(0.445, 0.100, 0.550, 0.900) infinite; } @keyframes load-x { 0% { left: -10px; transform: scale(1); } 25% { transform: scale(1.5); z-index: 2; } 50% { left: 60px; transform: scale(1); } 75% { transform: scale(0.5); z-index: 1; } 100% { left: -10px; transform: scale(1); } } @keyframes load-y { 0% { right: -10px; transform: scale(1); } 25% { transform: scale(0.5); } 50% { right: 60px; transform: scale(1); z-index: 1; } 75% { transform: scale(1.5); z-index: 2; } 100% { right: -10px; transform: scale(1); } } #loader p { text-align: center; font-family: 'Hanna', serif; font-weight: 50; color:rgba(192,41,66,1); animation: pulse 2s ease-in-out infinite; } @keyframes pulse { 50% { opacity: 0.5; } } // Loaded .loaded #loader-wrapper .loader-section.section-left { transform: translateY(-100%); transition: all 0.7s 0.3s cubic-bezier(0.645, 0.045, 0.355, 1.000); } .loaded #loader-wrapper .loader-section.section-right { transform: translateY(100%); transition: all 0.7s 0.3s cubic-bezier(0.645, 0.045, 0.355, 1.000); } .loaded #loader { opacity: 0; transition: all 0.3s ease-out; } .loaded #loader-wrapper { visibility: hidden; transform: translateX(-100%); transition: all 0.3s 1s ease-out; } */
...
.main-header .header-top .location-box .location-carousel .owl-nav .owl-next{
  ...
  height: 24px;
  line-height: 24px;
  background: #bbd3ec !important;
  text-align: center;
  border-radius: 5px;
  font-size: 10px !important;
  color: #374965 !important;
  cursor: pointer;
  z-index: 1;
  margin: 0px 2.5px;
  transition: all 500ms ease;
...
.industries-section .sec-title .top-title:after{
  background: #b1c0cf;
  border-left: 2px solid #374965;
  border-bottom: 2px solid #374965;
}
...
.industries-section .tabs-content .image-box:before{
  position: absolute;
  content: '';
  background: -webkit-linear-gradient(-90deg, rgba(70,43,52,0.0), rgb(187, 211, 236) 100%);
  width: 100%;
  height: 100%;
  left: 0px;
  right: 0px;
...
.team-section .sec-title .top-title:after{
  border-left: 2px solid #bbd3ec;
  border-bottom: 2px solid #bbd3ec;
}
...
.clients-style-two:before{
  position: absolute;
  content: '';
  background: -webkit-linear-gradient(-90deg, rgb(187 211 236 / 66%) 10%, rgba(255, 255, 255, 1) 90%);
  width: 100%;
  height: 100%;
  left: 0px;
  top: 0px;
...
.project-style-two .more-text p a{
  ...
  color: #374965;
  line-height: 30px;
  border-bottom: 1px solid #374965;
}
...
.default-form .form-group .nice-select:after {
  border-bottom: 2px solid #5d5f64;
  border-right: 2px solid #5d5f64;
}
...
.main-footer .footer-subscribe .subscribe-form .form-group input:focus{
  border-bottom: 1px solid #526d97 !important;
}
...
#image_block_1 .image-box .video-inner .border{
  border: 1px solid #526d97 !important;
}
...
.service-style-two .inner-container .single-item .text a:hover{
  color: #526d97;
  border-bottom: 1px solid #526d97;
}
