...
<div class="container-fluid">
    <div class="heading mb-4">
        ...
        <div class="kicker-bottom">Add New Credential Type</div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form id="credential-type-form" action="<?= base_url('admin/credential-types/store') ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <button type="submit" class="btn thm-btn px-4 mr-2">Create Credential Type</button>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $btn.prop('disabled', false).text('Create Credential Type');
                    }
                },
                error: function() {
