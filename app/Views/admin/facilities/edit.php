...
<div class="container-fluid">
    ...
    <form id="facility-form" action="<?= base_url('admin/facilities/update/' . $facility['id']) ?>" method="post" enctype="multipart/form-data"
        ...
        <input type="hidden" name="provider_id" value="<?= $facility['provider_id'] == 0 ? 'others' : $facility['provider_id'] ?>">

        <div class="row">
            <div class="col-lg-7">
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <input type="hidden" name="company_logo_path" id="company_logo_path" value="<?= $facility['company_logo'] ?>">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12 text-center">
                                ...
                                <div id="logo-dropzone" class="dropzone d-flex align-items-center justify-content-center" 
                                    data-existing-logo="<?= !empty($facility['company_logo']) ? base_url($facility['company_logo']) : '' ?>">
                        ...
                        <?php if ($facility['provider_id'] != 0): ?>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="p-2 bg-light rounded text-muted"><?= nl2br(esc($facility['company_address'])) ?></div>
                            </div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Company Name</label>
                                <input type="text" name="company_name" class="form-control" placeholder="Facility Name" value="<?= esc($facility['company_name']) ?>">
                            </div>

                            <div class="form-group mb-3">
                                <label class="form-label fw-bold">Company Address</label>
                                <textarea name="company_address" class="form-control" rows="2" placeholder="Full address"><?= esc($facility['company_address']) ?></textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label fw-bold">Zip Code</label>
                                        <input type="text" name="zip_code" class="form-control" placeholder="Zip code" value="<?= esc($facility['zip_code']) ?>">
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" name="company_email" class="form-control" placeholder="Email contact" value="<?= esc($facility['company_email']) ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="company_number" class="form-control" placeholder="Phone contact" value="<?= esc($facility['company_number']) ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="status" class="form-select form-control selectpicker">
                                        <option value="10" <?= $facility['status'] == 10 ? 'selected' : '' ?>>Active</option>
