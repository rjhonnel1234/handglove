            ...
            <div class="card-body">
                <form id="faq-form" action="<?= base_url('admin/faqs/store') ?>" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="answer" id="answer" rows="6" class="form-control" placeholder="Enter the answer" required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn thm-btn w-100 py-2 btn-save">Save FAQ</button>
                    </div>
                </form>
            </div>
        </div>
