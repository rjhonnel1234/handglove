...
<div class="container-fluid">
    <div class="heading mb-4">
        <h2>Leads</h2>
        <div class="kicker-bottom">Add New Lead</div>
    </div>

    <form id="lead-form" action="<?= base_url('admin/leads/store') ?>" method="post">
        <?= csrf_field() ?>
        <div class="row">
            <div class="col-lg-7">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <div class="pb-2">
                                    <span class="badge bg-warning text-white rounded-pill px-3 py-2">Manual</span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="date" class="form-control datepicker" placeholder="Select Date" value="<?= date('Y-m-d') ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="institution_id" id="institution_id" class="form-select form-control selectpicker" data-live-search="true" required>
                                                ...
                                                <?php foreach ($institutions as $inst): ?>
                                                    <option value="<?= $inst['id'] ?>"><?= esc($inst['name']) ?></option>
                                                <?php endforeach; ?>
                                ...
                                <div id="other_company_div" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="country" class="form-select form-control selectpicker" data-live-search="true">
                                                            ...
                                                            <?php foreach ($countries as $country): ?>
                                                                <option value="<?= $country['id'] ?>" <?= $country['id'] == 233 ? 'selected' : '' ?>><?= esc($country['name']) ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="status" data-tile="Select Status" class="form-select form-control selectpicker">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body d-flex justify-content-end gap-2">
                <button type="submit" class="btn thm-btn px-4 mr-2">Create Lead</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Add 4 initial rows as per image
