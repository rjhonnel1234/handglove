...
<div class="container-fluid">
    <div class="heading mb-4">
        <h2>Institutions</h2>
        <div class="kicker-bottom">Add New Institution</div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form id="institution-form" action="<?= base_url('admin/institutions/store') ?>" method="post">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="ccn" class="form-control" placeholder="Enter CCN" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="contact_number" class="form-control" placeholder="Enter phone number">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <button type="submit" class="btn thm-btn px-4 mr-2">Create Institution</button>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $btn.prop('disabled', false).text('Create Institution');
                    }
                },
                error: function() {
