<!--Page Title-->
<section class="page-title" style="background-image: url(/assets/img/background/page-title-2.jpg);">
    <div class="pattern-layer" style="background-image: url(/assets/img/shape/pattern-35.png);"></div>
                ...
                <div id="content_block_6">
                    <div class="content-box">
                        ...
                        <ul class="info-list clearfix">
                            ...
                            <li>
                                <figure class="icon-box"><img src="/assets/img/icons/icon-40.png" alt=""></figure>
                                <div class="inner">
                                    <h4>Call or Email</h4>
                                    <p>
                                        <a href="tel:+14438730011">(443) 873-0011</a><br />
                                        <a href="mailto:info@handglove.net">info@handglove.com</a>
                                    </p>
                                </div>
                            </li>
                            <li>
                                <figure class="icon-box"><img src="/assets/img/icons/icon-41.png" alt=""></figure>
                                <div class="inner">
                                    <h4>Office Hrs</h4>
