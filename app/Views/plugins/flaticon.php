<style>
  	...
  	Creation date: 25/06/2026 05:05
  	*/

@font-face {
  font-family: "Flaticon";
  src: url("<?php echo base_url('assets/webfonts/flaticon/Flaticon.eot'); ?>");
  src: url("<?php echo base_url('assets/webfonts/flaticon/Flaticon.eot?#iefix'); ?>") format("embedded-opentype"),
       url("<?php echo base_url('assets/webfonts/flaticon/Flaticon.woff2'); ?>") format("woff2"),
       url("<?php echo base_url('assets/webfonts/flaticon/Flaticon.woff'); ?>") format("woff"),
       url("<?php echo base_url('assets/webfonts/flaticon/Flaticon.ttf'); ?>") format("truetype"),
       url("<?php echo base_url('assets/webfonts/flaticon/Flaticon.svg#Flaticon'); ?>") format("svg");
  font-weight: normal;
  font-style: normal;
}
